Shader "Custom/3DPrinterEffectv11"
{
    Properties
    {
        ...
        _WireframeColorDarkB1("Wireframe Color Dark B 1", Color) = (0, 0.5, 0, 1)
        _WireframeColorLightB2("Wireframe Color Light B 2", Color) = (0, 1, 0, 1)
        _WireframeColorDarkB2("Wireframe Color Dark B 2", Color) = (0, 0.5, 0, 1)
        _WireframeThicknessA("Wireframe Thickness A", Range(0, 10)) = 2
        _WireframeThicknessB("Wireframe Thickness B", Range(0, 10)) = 1.5
        ...
        [HDR] _ConstructEmissionB ("Construct Emission B", color) = (0, 0.45, 0.6, 1)
        ...
        _WireframeAlphaA("Wireframe Alpha A", Range(0, 1)) = 0.8
        _WireframeAlphaB("Wireframe Alpha B", Range(0, 1)) = 0.2
    }
    SubShader
    {
        Tags
